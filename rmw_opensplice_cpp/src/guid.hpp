...
inline void DDS_InstanceHandle_to_GUID(struct GuidPrefix_t *guid, DDS::InstanceHandle_t instanceHandle) {
  memcpy(guid->value, (char *) &instanceHandle, guid->size);
}

inline void DDS_BuiltinTopicKey_to_GUID(struct GuidPrefix_t *guid, DDS::BuiltinTopicKey_t buitinTopicKey) {
#if BIG_ENDIAN
  /* Big Endian */
