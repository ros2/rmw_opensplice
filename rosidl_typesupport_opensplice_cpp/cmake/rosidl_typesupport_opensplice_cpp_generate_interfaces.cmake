...
foreach(_idl_file ${rosidl_generate_interfaces_IDL_FILES})
  ...
  elseif("${_extension}" STREQUAL ".srv")
    ...
    list(APPEND _dds_idl_files "${_dds_idl_path}/WriteSample${name}Request_.idl")
    list(APPEND _dds_idl_files "${_dds_idl_path}/WriteSample${name}Response_.idl")
  endif()
endforeach()
...
foreach(_idl_file ${rosidl_generate_interfaces_IDL_FILES})
  ...
  elseif("${_extension}" STREQUAL ".srv")
    ...
    list(APPEND _generated_files "${_output_path}/Sample${name}Request_.h")
    list(APPEND _generated_files "${_output_path}/Sample${name}Request_.cpp")
    list(APPEND _generated_files "${_output_path}/Sample${name}Request_Dcps.h")
    list(APPEND _generated_files "${_output_path}/Sample${name}Request_Dcps.cpp")
    list(APPEND _generated_files "${_output_path}/Sample${name}Request_Dcps_impl.h")
    list(APPEND _generated_files "${_output_path}/Sample${name}Request_Dcps_impl.cpp")
    list(APPEND _generated_files "${_output_path}/Sample${name}Request_SplDcps.h")
    list(APPEND _generated_files "${_output_path}/Sample${name}Request_SplDcps.cpp")
    list(APPEND _generated_files "${_output_path}/ccpp_Sample${name}Request_.h")

    list(APPEND _generated_files "${_output_path}/WriteSample${name}Request_.h")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Request_.cpp")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Request_Dcps.h")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Request_Dcps.cpp")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Request_Dcps_impl.h")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Request_Dcps_impl.cpp")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Request_SplDcps.h")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Request_SplDcps.cpp")
    list(APPEND _generated_files "${_output_path}/ccpp_WriteSample${name}Request_.h")

    list(APPEND _generated_files "${_output_path}/Sample${name}Response_.h")
    list(APPEND _generated_files "${_output_path}/Sample${name}Response_.cpp")
    list(APPEND _generated_files "${_output_path}/Sample${name}Response_Dcps.h")
    list(APPEND _generated_files "${_output_path}/Sample${name}Response_Dcps.cpp")
    list(APPEND _generated_files "${_output_path}/Sample${name}Response_Dcps_impl.h")
    list(APPEND _generated_files "${_output_path}/Sample${name}Response_Dcps_impl.cpp")
    list(APPEND _generated_files "${_output_path}/Sample${name}Response_SplDcps.h")
    list(APPEND _generated_files "${_output_path}/Sample${name}Response_SplDcps.cpp")
    list(APPEND _generated_files "${_output_path}/ccpp_Sample${name}Response_.h")

    list(APPEND _generated_files "${_output_path}/WriteSample${name}Response_.h")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Response_.cpp")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Response_Dcps.h")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Response_Dcps.cpp")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Response_Dcps_impl.h")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Response_Dcps_impl.cpp")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Response_SplDcps.h")
    list(APPEND _generated_files "${_output_path}/WriteSample${name}Response_SplDcps.cpp")
    list(APPEND _generated_files "${_output_path}/ccpp_WriteSample${name}Response_.h")
  endif()
endforeach()
